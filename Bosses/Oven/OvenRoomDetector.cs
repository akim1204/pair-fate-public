...
public partial class OvenRoomDetector : Area2D
{
	...
	public void _on_area_entered(Area2D area)
	{
		...
		if (!activated && area.GetType().IsAssignableTo(typeof(PlayerHurtbox)))
		{
			/* Get the jello controller */
			OvenController controller = GetNode<OvenController>("../../bossController0");
